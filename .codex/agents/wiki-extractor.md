...
Codex compatibility: this file is a repo-local role instruction. Map the original Claude tool list to Codex file reads, `rg`, shell commands, and `apply_patch`; follow the behavioral constraints rather than the literal tool names.
